package ru.ksodd.Runners.type_tests.Initiative_MVK;
...
//        tags = {"@smokeTest#1,@smokeTest#2,@smokeTest#3"}, //Запустить несколько фич
        tags = {"@scenario#Initiative_type_MVK, @scenario#Request_type_actual_initCODD"},
...
public class Initiative_MVK_req_actual_init_CODD {
