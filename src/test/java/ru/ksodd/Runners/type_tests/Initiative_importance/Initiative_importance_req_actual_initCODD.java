package ru.ksodd.Runners.type_tests.Initiative_importance;
...
//        tags = {"@smokeTest#1,@smokeTest#2,@smokeTest#3"}, //Запустить несколько фич
        tags = {"@scenario#Initiative_type_Importance, @scenario#Request_type_actual_initCODD"},
...
public class Initiative_importance_req_actual_initCODD {
